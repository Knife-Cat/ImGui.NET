...
namespace imnodesNET
{
    public static unsafe partial class imnodes
    {
        ...
        public static void DestroyContext(ref IntPtr ctx)
        {
            imnodesNative.ImNodes_DestroyContext(ctx);
        }
        ...
        public static void EditorContextFree(ref IntPtr noname1)
        {
        ...
        public static void EditorContextSet(ref IntPtr noname1)
        {
        ...
        public static bool IsLinkCreated(ref int started_at_attribute_id, ref int ended_at_attribute_id)
        {
            ...
            fixed (int* native_started_at_attribute_id = &started_at_attribute_id)
            {
                ...
                {
                    byte ret = imnodesNative.ImNodes_IsLinkCreated_BoolPtr(native_started_at_attribute_id,
                        native_ended_at_attribute_id, created_from_snap);
                    return ret != 0;
                }
            }
        }
            ...
            ref bool created_from_snap)
        {
            ...
            fixed (int* native_started_at_attribute_id = &started_at_attribute_id)
            {
                ...
                {
                    byte ret = imnodesNative.ImNodes_IsLinkCreated_BoolPtr(native_started_at_attribute_id,
                        native_ended_at_attribute_id, native_created_from_snap);
        ...
        public static bool IsLinkCreated(ref int started_at_node_id, ref int started_at_attribute_id,
            ref int ended_at_node_id, ref int ended_at_attribute_id)
        {
            byte* created_from_snap = null;
            fixed (int* native_started_at_node_id = &started_at_node_id)
            {
                fixed (int* native_started_at_attribute_id = &started_at_attribute_id)
                {
                    fixed (int* native_ended_at_node_id = &ended_at_node_id)
                    {
                        fixed (int* native_ended_at_attribute_id = &ended_at_attribute_id)
                        {
                            byte ret = imnodesNative.ImNodes_IsLinkCreated_IntPtr(native_started_at_node_id,
                                native_started_at_attribute_id, native_ended_at_node_id, native_ended_at_attribute_id,
                                created_from_snap);
                            return ret != 0;
                        }
                    }
        ...
        public static bool IsLinkCreated(ref int started_at_node_id, ref int started_at_attribute_id,
            ref int ended_at_node_id, ref int ended_at_attribute_id, ref bool created_from_snap)
        {
            byte native_created_from_snap_val = created_from_snap ? (byte)1 : (byte)0;
            byte* native_created_from_snap = &native_created_from_snap_val;
            fixed (int* native_started_at_node_id = &started_at_node_id)
        ...
        public static bool IsLinkDropped(ref int started_at_attribute_id)
        {
            ...
            fixed (int* native_started_at_attribute_id = &started_at_attribute_id)
            {
                byte ret = imnodesNative.ImNodes_IsLinkDropped(native_started_at_attribute_id,
        ...
        public static bool IsLinkDropped(ref int started_at_attribute_id, bool including_detached_links)
        {
            ...
            {
                byte ret = imnodesNative.ImNodes_IsLinkDropped(native_started_at_attribute_id,
                    native_including_detached_links);
                return ret != 0;
            }
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
        public static void LoadEditorStateFromIniFile(ref IntPtr editor, ReadOnlySpan<char> file_name)
        {
            byte* native_file_name;
            int file_name_byteCount = 0;
            if (file_name != null)
...
#endif
        public static void LoadEditorStateFromIniFile(ref IntPtr editor, string file_name)
        {
            byte* native_file_name;
            int file_name_byteCount = 0;
            if (file_name != null)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
        public static void LoadEditorStateFromIniString(ref IntPtr editor, ReadOnlySpan<char> data, uint data_size)
        {
            byte* native_data;
            int data_byteCount = 0;
            if (data != null)
...
#endif
        public static void LoadEditorStateFromIniString(ref IntPtr editor, string data, uint data_size)
        {
            byte* native_data;
            int data_byteCount = 0;
            if (data != null)
        ...
        public static void MiniMap()
        {
            ...
            IntPtr node_hovering_callback = IntPtr.Zero;
            void* node_hovering_callback_data = null;
            imnodesNative.ImNodes_MiniMap(minimap_size_fraction, location, node_hovering_callback,
        ...
        public static void MiniMap(float minimap_size_fraction, ImNodesMiniMapLocation location,
            IntPtr node_hovering_callback, IntPtr node_hovering_callback_data)
        {
            void* native_node_hovering_callback_data = (void*)node_hovering_callback_data.ToPointer();
            imnodesNative.ImNodes_MiniMap(minimap_size_fraction, location, node_hovering_callback,
                native_node_hovering_callback_data);
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
        public static void SaveEditorStateToIniFile(ref IntPtr editor, ReadOnlySpan<char> file_name)
        {
            byte* native_file_name;
            int file_name_byteCount = 0;
            if (file_name != null)
...
#endif
        public static void SaveEditorStateToIniFile(ref IntPtr editor, string file_name)
        {
            byte* native_file_name;
            int file_name_byteCount = 0;
            if (file_name != null)
        ...
        public static string SaveEditorStateToIniString(ref IntPtr editor)
        {
            uint* data_size = null;
        ...
        public static string SaveEditorStateToIniString(ref IntPtr editor, ref uint data_size)
        {
            fixed (uint* native_data_size = &data_size)
            {
        ...
        public static void SetCurrentContext(ref IntPtr ctx)
        {
