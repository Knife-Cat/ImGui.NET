...
namespace imnodesNET
{
    public static unsafe partial class imnodesNative
    {
        ...
        [DllImport("cimnodes", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImNodes_MiniMap(float minimap_size_fraction, ImNodesMiniMapLocation location, IntPtr node_hovering_callback, void* node_hovering_callback_data);
        [DllImport("cimnodes", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimnodes", CallingConvention = CallingConvention.Cdecl)]
        public static extern void LinkDetachWithModifierClick_destroy(IntPtr self);
        [DllImport("cimnodes", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr LinkDetachWithModifierClick_LinkDetachWithModifierClick();
    }
}
