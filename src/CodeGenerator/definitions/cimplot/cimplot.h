...
//based on implot.h file version 0.10 WIP from implot https://github.com/epezent/implot
...
struct ImPlotInputMap
{
    ...
    ImGuiKey BoxSelectMod;
    ImGuiMouseButton BoxSelectCancelButton;
    ImGuiMouseButton QueryButton;
    ImGuiKey QueryMod;
    ImGuiKey QueryToggleMod;
    ImGuiKey HorizontalMod;
    ImGuiKey VerticalMod;
};
...
CIMGUI_API bool ImPlot_BeginDragDropSource(ImGuiKey key_mods,ImGuiDragDropFlags flags);
CIMGUI_API bool ImPlot_BeginDragDropSourceX(ImGuiKey key_mods,ImGuiDragDropFlags flags);
CIMGUI_API bool ImPlot_BeginDragDropSourceY(ImPlotYAxis axis,ImGuiKey key_mods,ImGuiDragDropFlags flags);
